import { signInWithTwitter } from '..'
import { signInWithPopup } from 'firebase/auth'
import { addDoc, getDocs, collection } from 'firebase/firestore'
import { COLLECTIONS } from '../../../../const'

describe('auth >> signInWithTwitter', () => {
    beforeEach(() => {
        jest.resetAllMocks()
    })
    ...
    it('should throw an Error in case of rejection of signInWithPopup', async () => {
        ...
        try {
            ...
            expect(error.message).toBe('Error to sign in with a Twitter Account')
        }
    })
    ...
    it('should signIn correctly with a valid Twitter account', async () => {
        const mockUID = '__MOCK__UID__'
        const mockName = '__MOCK__NAME__'
        const mockEmail = '__MOCK__EMAIL__'
        const mockUser = {
    ...
    it('should signIn correctly with a valid Twitter account and add a new user if this the first access', async () => {
        const mockUID = '__MOCK__UID__'
        const mockName = '__MOCK__NAME__'
        const mockEmail = '__MOCK__EMAIL__'
        ;(signInWithPopup as jest.Mock).mockResolvedValue({
